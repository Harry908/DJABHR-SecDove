...
console.log('🔧 Migrating database to remove username foreign key constraints...');
...
async function migrateDatabase() {
  try {
    ...
    console.log('Recreating tables without username FK constraints...');
    ...
    console.log(`✓ Restored ${conversations.length} conversations`);
    ...
    console.log('All data preserved, foreign key constraints on usernames removed.');

  } catch (error) {
    console.error('❌ Migration failed:', error.message);
    console.error('You may need to recreate the database manually');
    process.exit(1);
  }
}
